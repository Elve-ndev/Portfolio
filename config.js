...
const CONFIG = {
  ...
  projects: [
    ...
    },
    {
      ...
      media: [
        "assets/ragavoruby.jpeg",
        "assets/rragavoruby.jpeg"
      ],
      year: "2026"
    }
  ],
  ...
  // C'est CE BLOC que le chatbot utilise
  ...
  rag: {
    whoami: `
      ...
      Before the engineering cycle I completed two years of Classes Préparatoires aux Grandes Écoles (CPGE).
    ...
    education: `
      ...
      Previously: Classes Préparatoires aux Grandes Écoles (CPGE).
  ...
  // ANTHROPIC / CLAUDE
  // ═══════════════════════════════
  // Ne stockez PAS la clé ici si le dépôt est public.
